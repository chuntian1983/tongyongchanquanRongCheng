...
namespace NY.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["DataBaseLinks"].ConnectionString;      
        public DbHelperSQL()
        {
        }
        ...
        public static int MyExecuteSQL(string TableName, Dictionary<string, string> dbParameters, string wh)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
                try
                {
                    ...
                    foreach (KeyValuePair<string, string> para in dbParameters)
                    {
                        sql.AppendFormat("{0}={1},", para.Key, para.Value);
                    }
