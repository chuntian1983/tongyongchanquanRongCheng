<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consulting.aspx.cs" Inherits="Web.SuperWeb.bc.consulting" %>
...
<head runat="server">
    ...
    <script src="../js/consulting.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no" oncontextmenu="return false" onselectstart="return false">
    ...
    <div region="center">
        ...
        <div id="Edit" style="display: none; width: 100%; height: 100%; overflow: hidden;">
            <div class="easyui-panel" title="业务咨询信息" style="width: 100%; height: 97%;">
