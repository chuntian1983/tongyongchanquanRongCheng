...
//mmenucolor='#3d8543';
mfontcolor='white';
mmenuoutcolor='#ADEF34';
mmenuincolor='#B5E74E';
//mmenuoutbordercolor='#ECFA3A';
mmenuoutbordercolor='#5A2614';
mmenuinbordercolor='#5A2614';
mmidoutcolor='#A9DA1D';
mmidincolor='#799310';
mmenuovercolor='#004080';
mitemedge='0';
msubedge='1';
mmenuunitwidth=80;
mmenuitemwidth=120;
...
mmenuadjust=0;
mmenuadjustV=0;
mfonts='font-family: ËÎÌו; font-size: 11pt; color: white; ';
mcursor='hand';
var swipeSteps = 4;
var swipemsec = 25;
...
function mwritetodocument(){
     var stringx='<div id="mposflag" style="position:absolute;"></div>'+
         '<table  id=mmenutable border=0 cellpadding=3 cellspacing=2 width='+mmenuwidth+' height='+mmenuheight+
