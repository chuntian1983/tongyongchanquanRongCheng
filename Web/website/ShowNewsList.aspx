<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowNewsList.aspx.cs" Inherits="Web.website.ShowNewsList" %>
                            ...
                            <tr>
                              ...
                              <uc3:LeftInfo0 ID="LeftInfo0_1" runat="server"></uc3:LeftInfo0>                              </td>
                                <td width="76%" valign="middle" style="height: 37px; color: #454545; font-size: 14px; text-align: left;
                                    ...
                                    <%=ClassName %><span style=" padding:60px;"></span> 关键字<asp:TextBox ID="txtkeyword" runat="server" 
                Width="60px" CssClass=wid1></asp:TextBox>
            <asp:ImageButton
                ID="ImageButton1" runat="server" ImageUrl="~/website/images/chaxun.png" 
                Width="20px" onclick="ImageButton1_Click" CssClass=wid2 />
                              </td>
                            </tr>
                            <tr>
